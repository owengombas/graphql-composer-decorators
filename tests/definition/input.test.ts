...
describe("InputType", () => {
  it("Should create an input type", async () => {
    const testInput1 = schema.types[0] as ComposerInputType;
    const testInput2 = schema.types[1] as ComposerInputType;
    const testInput3 = schema.types[2] as ComposerInputType;
